                ...
                {todayTasks.length===0?(
                  ...
                  <>
                    ...
                    <div style={{display:"flex",flexDirection:"column",gap:10}}>
                      {(()=>{
                        const overlappingIds=getOverlappingIds(todayTasks);
                                      ...
                                      <div key={t.id}>
                                        ...
                                        {isSegExpanded&&hasMultiple&&(
                                          <div style={{background:faint,borderRadius:"0 0 10px 10px",border:`1px solid ${bdr}`,borderTop:"none",padding:"6px 12px 8px",display:"flex",flexDirection:"column",gap:4}}>
                                            {t._segs.map((seg,i)=>(
                                              <div key={seg.id} style={{display:"flex",alignItems:"center",gap:8,padding:"4px 6px",borderRadius:6}}>
                                                ...
                                                <div style={{fontFamily:"'IBM Plex Mono',monospace",fontSize:11,color:muted}}>{fmtMins(seg.duration||(active?.id===seg.id?elapsed:0))}</div>
                                              </div>
                                            ))}
                                          </div>
                                        )}
