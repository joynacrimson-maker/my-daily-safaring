                                      ...
                                      <div key={t.id}>
                                        <div style={{...card, padding:"10px 14px", display:"flex", alignItems:"center", gap:10,
                                          ...
                                          {!isEditing&&<>
                                            ...
                                            {!isAct&&!t.planned&&!hasMultiple&&<button onClick={()=>openEditTask(t)} style={{...btnS,fontSize:11,padding:"3px 8px",flexShrink:0,color:isOverlap?"#E8A030":tx,borderColor:isOverlap?"rgba(232,160,48,0.5)":bdr}}>&#9998; Edit</button>}
